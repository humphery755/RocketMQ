...
//    }
    ...
    public void testMatchSimple() {
        Subscription slashSub = new Subscription("FAKE_CLI_ID_1", "/", MessageType.QOS_MOST_ONE, false,-1);
        store.add(slashSub);
        assertTrue(store.matches("finance").isEmpty());
        
        Subscription slashFinanceSub = new Subscription("FAKE_CLI_ID_1", "/finance", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void testMatchSimpleMulti() {
        Subscription anySub = new Subscription("FAKE_CLI_ID_1", "#", MessageType.QOS_MOST_ONE, false,-1);
        store.add(anySub);
        assertTrue(store.matches("finance").contains(anySub));
        
        Subscription financeAnySub = new Subscription("FAKE_CLI_ID_1", "finance/#", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void testMatchingDeepMulti_two_layer() {
        Subscription financeAnySub = new Subscription("FAKE_CLI_ID_1", "finance/stock/#", MessageType.QOS_MOST_ONE, false,-1);
        store.add(financeAnySub);
    ...
    public void testMatchSimpleSingle() {
        ...
        Subscription financeOne = new Subscription("FAKE_CLI_ID_1", "finance/+", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void testMatchManySingle() {
        Subscription manySub = new Subscription("FAKE_CLI_ID_1", "+/+", MessageType.QOS_MOST_ONE, false,-1);
        store.add(manySub);
    ...
    public void testMatchSlashSingle() {
        Subscription slashPlusSub = new Subscription("FAKE_CLI_ID_1", "/+", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void testMatchManyDeepSingle() {
        Subscription slashPlusSub = new Subscription("FAKE_CLI_ID_1", "/finance/+/ibm", MessageType.QOS_MOST_ONE, false,-1);
        store.add(slashPlusSub);
        
        Subscription slashPlusDeepSub = new Subscription("FAKE_CLI_ID_1", "/+/stock/+", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void testMatchSimpleMulti_allTheTree() {
        store.add(new Subscription("FAKE_CLI_ID_1", "#", MessageType.QOS_MOST_ONE, false,-1));
    ...
    public void testMatchSimpleMulti_zeroLevel() {
        ...
        store.add(new Subscription("FAKE_CLI_ID_1", "finance/#", MessageType.QOS_MOST_ONE, false,-1));
        assertFalse(store.matches("finance").isEmpty());
    }
    ...
    private void assertMatch(String subscription, String topic) {
        store = new SubscriptionsStore();
        store.init(new MemoryStorageService());
        Subscription sub = new Subscription("FAKE_CLI_ID_1", subscription, MessageType.QOS_MOST_ONE, false,-1);
        store.add(sub);
    ...
    public void testRemoveClientSubscriptions_existingClientID() {
        ...
        store.add(new Subscription(cliendID, "finance/#", MessageType.QOS_MOST_ONE, false,-1));
    ...
    public void removeSubscription_withDifferentClients_subscribedSameTopic() {
        ...
        Subscription slashSub = new Subscription("FAKE_CLI_ID_1", "/topic", MessageType.QOS_MOST_ONE, false,-1);
        aStore.add(slashSub);
        aStore.deactivate(slashSub.getClientId());
        
        //subscribe an active clientID2 to /topic
        Subscription slashSub2 = new Subscription("FAKE_CLI_ID_2", "/topic", MessageType.QOS_MOST_ONE, false,-1);
    ...
    public void overridingSubscriptions() {
        Subscription oldSubscription = new Subscription("FAKE_CLI_ID_1", "/topic", MessageType.QOS_MOST_ONE, false,-1);
        store.add(oldSubscription);
        Subscription overrindingSubscription = new Subscription("FAKE_CLI_ID_1", "/topic", MessageType.QOS_EXACTLY_ONCE, false,-1);
