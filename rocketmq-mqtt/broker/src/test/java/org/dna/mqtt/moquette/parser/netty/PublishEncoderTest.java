...
import static org.dna.mqtt.moquette.parser.netty.TestUtils.verifyBuff;
import static org.dna.mqtt.moquette.parser.netty.TestUtils.verifyString;
...
public class PublishEncoderTest {
    ...
    public void testEncode_qos_reserved() throws Exception {
        PublishMessage msg = new PublishMessage();
        msg.setQos(MessageType.QOS_RESERVED);
        msg.setMessageID(1);
        msg.setTopicName(null);
