 ...
 */
package com.alibaba.rocketmq.broker.transaction.log;
...
public class TransactionLogStore implements TransactionStore {
    ...
    public TransactionLogStore(final DefaultMessageStore defaultMessageStore) {
...
/*            private final TransactionCheckExecuter transactionCheckExecuter =
                    TransactionLogStore.this.defaultMessageStore.getTransactionCheckExecuter();*/
            private final long checkTransactionMessageAtleastInterval =
                    TransactionLogStore.this.defaultMessageStore.getMessageStoreConfig()
                        .getCheckTransactionMessageAtleastInterval();
            private final boolean slave = TransactionLogStore.this.defaultMessageStore
            ...
            public void run() {
                ...
                // Check功能是否开启
               /* if (!TransactionLogStore.this.defaultMessageStore.getMessageStoreConfig()
            ...
            private long getTranStateOffset(final long currentIndex) {
                long offset =
                        (this.mapedFile.getFileFromOffset() + currentIndex)
                                / TransactionLogStore.TSStoreUnitSize;
                return offset;
            }
	...
	public boolean put(TransactionRecord trs) {
		 MapedFile mapedFile = this.tranStateTable.getLastMapedFile();
	        ...
	        // Commit Log Offset
	        this.byteBufferAppend.putLong(trs.getOffset());
	        // Message Size
	        this.byteBufferAppend.putInt(trs.getMsgSize());
	        // Timestamp
	        this.byteBufferAppend.putInt(trs.getTimestamp());
	        // Producer Group Hashcode
	        this.byteBufferAppend.putInt(trs.getPgroupHashCode());
	        // Transaction State
	        this.byteBufferAppend.putInt(MessageSysFlag.TransactionPreparedType);
