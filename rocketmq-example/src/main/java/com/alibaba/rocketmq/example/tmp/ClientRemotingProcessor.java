...
public class ClientRemotingProcessor {
    ...
    public static RemotingCommand consumeMessageDirectly(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        ...
        ConsumeMessageDirectlyResult result =
                mqClientFactory.consumeMessageDirectly(msg, requestHeader.getConsumerGroup(),
    ...
    public static  RemotingCommand getConsumerRunningInfo(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        final RemotingCommand response = RemotingCommand.createResponseCommand(null);
        ...
        ConsumerRunningInfo consumerRunningInfo =
                mqClientFactory.consumerRunningInfo(requestHeader.getConsumerGroup());
     ...
     * Oneway调用，无返回值
     */
    public static RemotingCommand checkTransactionState(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        ...
        if (messageExt != null) {
            ...
            if (group != null) {
                MQProducerInner producer = mqClientFactory.selectProducer(group);
                if (producer != null) {
     ...
     * Oneway调用，无返回值
     */
    public static RemotingCommand notifyConsumerIdsChanged(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        try {
     ...
     */
    public static RemotingCommand resetOffset(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        ...
        mqClientFactory.resetOffset(requestHeader.getTopic(), requestHeader.getGroup(), offsetTable);
        return null;
    }
     ...
     */
    @Deprecated
    public static RemotingCommand getConsumeStatus(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        final RemotingCommand response = RemotingCommand.createResponseCommand(null);
        ...
        Map<MessageQueue, Long> offsetTable =
                mqClientFactory.getConsumerStatus(requestHeader.getTopic(), requestHeader.getGroup());
